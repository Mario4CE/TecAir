...
Salidas:
Proporciona propiedades tipadas consumidas por Program y endpoints.
Restricciones:
...
{
    public string CorsOrigin { get; set; } = ApiGlobals.DefaultCorsOrigin; // Permitir solicitudes desde cualquier origen
